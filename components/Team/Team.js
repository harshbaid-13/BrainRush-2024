...
const Team = () => {
  return (
  <>
    <Heading title={"Organising Team"} header ={"Our Dedicated"} hearerspan="Team Members
" subheader="Lorem ipsum dolor sit amet, consectetur adipiscing elit. In convallis"subheaderspan1="tortor eros. Donec vitae tortor lacus. Phasellus aliquam ante in maximus." subheaderspan2="" />
      ...
      <div class="grid gap-8 lg:gap-16 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
        {
          ...
          <div class="text-center text-gray-500 p-3 dark:text-gray-400 rounded-lg relative border-2 border-[#DA6B26] shadow-xl shadow-[#DA6B26]">
            <div className="absolute top-0 left-40 h-16 w-16 text-4xl  rounded-full z-2">
                      {e.emoji}
                    </div>
              <img class="mx-auto mb-4 w-36 h-36 rounded-full " src={e.photo} alt="Bonnie Avatar"/>
              ...
              <ul class="flex justify-center mt-4 space-x-4">
                  <li>
                      <a href={e.whatsapp} class="text-[#00B315] hover:text-[#00F71D] dark:hover:text-white">
