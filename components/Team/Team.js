...
const Team = () => {
  return (
    <>
    <Heading title={"Organising Team"} header ={"Meet With Our Creative"} hearerspan="Dedicated Team
      ...
      <div class="grid gap-8 lg:gap-16 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
        {
          ...
          <div class="text-center text-gray-500 dark:text-gray-400 relative">
            <div className="absolute top-0 left-40 h-16 w-16 text-4xl  rounded-full z-2">
              ...
              <ul class="flex justify-center mt-4 space-x-4">
                  <li>
                      <a href={e.whatsapp} class="text-[#39569c] hover:text-gray-900 dark:hover:text-white">
