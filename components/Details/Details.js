...
const Details = () => {
  ...
  return (
    <>
      ...
      //   background:
      //     "linear-gradient(317deg, rgba(255,248,227,1) 3%, rgba(117,234,231,1) 46%, rgba(159,204,237,1) 95%);",
      // }}
      >
        <Heading
          title={"Our Schedule"}
          ...
          <div className="py-8 ml-2 md:ml-5">
            <div className="container mx-auto flex flex-col items-start md:flex-row my-12 md:my-24">
              <div className="flex flex-col w-full sticky md:top-36 lg:w-1/3 mt-2 md:mt-12 px-4 md:px-14">
                <p className="text-3xl font-['lobster'] md:text-5xl mb-3 text-logoYellow uppercase tracking-loose">
                  Timeline
                </p>
